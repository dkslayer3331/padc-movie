...
class DetailActivity : AppCompatActivity(),DetailView {
   ...
   private fun bindGenres(genres : List<GenreVo>){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvLabelMoreCreators.text = HtmlCompat.fromHtml(getString(R.string.more_creators), HtmlCompat.FROM_HTML_MODE_LEGACY)
    ...
    override fun showDetail(movieDetailVO: MovieDetailVO) {
        ...
        ratingBar.rating = movieDetailVO.voteAverage.toFloat()
